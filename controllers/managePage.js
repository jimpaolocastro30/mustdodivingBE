...
exports.addManagePage = (req, res) => {
  ...
  const { pageUrl, pageTitle, pageDescription, animalType,scientificName, diet, averageLifeSpan,urlMain, urlSub, estimatedWeight, estimatedSize,  pageBody} = req.body;
  let mmedias = new mpage({ pageId, pageUrl, pageTitle, pageDescription, animalType,scientificName, urlMain, urlSub, diet, averageLifeSpan, estimatedWeight, estimatedSize, pageBody, dateCreated, dateUpdated});
